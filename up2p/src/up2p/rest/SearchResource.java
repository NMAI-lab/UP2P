...
public class SearchResource {
	...
	public SearchResource(String comid, UserWebAdapter adapter) {
		communityId= comid;
	...
	public Response addresource(InputStream is) {
		try{
			...
			System.out.println("community="+communityId+ "query="+query);
			...
			String respid = adapter.searchG(communityId, query);
